...
namespace Pruebaunoparcial.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmpleadoId,Cedula,Nombre,Apellido,Direccion,Telefono,Email,Tipo_gabinete")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpleadoId,Cedula,Nombre,Apellido,Direccion,Telefono,Email,Tipo_gabinete")] Empleado empleado)
        {
